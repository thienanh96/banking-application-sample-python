...
class AccountManagementUseCase:
    ...
    def create_account(self, customer_id: str | None, name: str | None, email: str | None, phone_number: str | None) -> Account:
        ...
        if customer_id:
            ...
            customer = Customer(self.customer_repository.next_identity(), name, email, phone_number)
        ...
        account: Account = Account(account_id, customer.customer_id, account_number)
